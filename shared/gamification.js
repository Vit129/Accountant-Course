...
function showTrackCertificate(trackTitle) {
  ...
  overlay.innerHTML = `
    <div style="background:#FAF4E7;color:#2B2620;border-radius:12px;padding:32px 40px;max-width:420px;text-align:center;border:4px double #f59e0b;box-shadow:0 20px 60px rgba(0,0,0,.4);">
